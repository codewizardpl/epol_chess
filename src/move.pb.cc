...
void protobuf_AddDesc_move_2eproto() {
  ...
  ::google::protobuf::DescriptorPool::InternalAddGeneratedFile(
    "\n\nmove.proto\022\005chess\" \n\004Move\022\014\n\004from\030\001 \002("
    "\t\022\n\n\002to\030\002 \002(\t", 53);
...
Move::Move()
  ...
  SharedCtor();
  // @@protoc_insertion_point(constructor:chess.Move)
}
...
Move::Move(const Move& from)
  ...
  SharedCtor();
  MergeFrom(from);
  // @@protoc_insertion_point(copy_constructor:chess.Move)
}
...
Move::~Move() {
  // @@protoc_insertion_point(destructor:chess.Move)
  SharedDtor();
}
...
#define DO_(EXPRESSION) if (!(EXPRESSION)) goto failure
  ...
  // @@protoc_insertion_point(parse_start:chess.Move)
  for (;;) {
...
success:
  // @@protoc_insertion_point(parse_success:chess.Move)
  return true;
failure:
  // @@protoc_insertion_point(parse_failure:chess.Move)
  return false;
#undef DO_
}
...
void Move::SerializeWithCachedSizes(
  ...
  // @@protoc_insertion_point(serialize_start:chess.Move)
  // required string from = 1;
  if (has_from()) {
    ::google::protobuf::internal::WireFormat::VerifyUTF8StringNamedField(
      this->from().data(), this->from().length(),
  ...
  // @@protoc_insertion_point(serialize_end:chess.Move)
}

::google::protobuf::uint8* Move::SerializeWithCachedSizesToArray(
    ::google::protobuf::uint8* target) const {
  // @@protoc_insertion_point(serialize_to_array_start:chess.Move)
  // required string from = 1;
  if (has_from()) {
    ::google::protobuf::internal::WireFormat::VerifyUTF8StringNamedField(
      this->from().data(), this->from().length(),
  ...
  // @@protoc_insertion_point(serialize_to_array_end:chess.Move)
  return target;
}
